...
<head>
  ...
  <link href="/Public/css//cms.css" rel="stylesheet">
	...
	<script>
	$(function(){$(".navbar-nav>li:eq(0)").addClass("active").siblings().removeClass("active");
});
</script>
...
<form role="form" action="<?php echo U('system/set');?>" method="post">	
	...
	<button type="submit" style="margin-left:10px" class="btn btn-primary">设置</button>
	</form>
