...
<div class="container">
   ...
   <?php $__FOR_START_1143430599__=0;$__FOR_END_1143430599__=$pages;for($i=$__FOR_START_1143430599__;$i < $__FOR_END_1143430599__;$i+=1){ if($i == $current_page): ?><li class="active"><a href="<?php echo U('Admin/Brand/index?page='.$i);?>"><?php echo ($i+1); ?><span class="sr-only">(current)</span></a></li>
