...
<head>
  ...
  <link href="/Public/css//cms.css" rel="stylesheet">
	...
	<script>
	$(function(){$(".navbar-nav>li:eq(2)").addClass("active").siblings().removeClass("active");});
</script>
...
<div class="container">
   ...
   <?php $__FOR_START_1264879289__=0;$__FOR_END_1264879289__=$pages;for($i=$__FOR_START_1264879289__;$i < $__FOR_END_1264879289__;$i+=1){ if($i == $current_page): ?><li class="active"><a href="<?php echo U('Admin/User/index?page='.$i);?>"><?php echo ($i+1); ?><span class="sr-only">(current)</span></a></li>
