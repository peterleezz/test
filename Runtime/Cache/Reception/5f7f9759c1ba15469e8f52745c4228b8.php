  ...
  var grid_selector = "#reception_card_grid";
    ...
    $("#menu_44").addClass("active");
                ...
                jQuery(grid_selector).jqGrid({
                    ...
                    mtype:"POST",
                    colNames:['ID','member_id', '卡号','办理会所','卡种名称','卡状态','签订日期', '会员姓名','手机号码','有效期起','有效期止','免费请假次数', '操作'],
                    colModel:[   
                       ...
                       {name:'card_number',index:'card_number',width:150,align:'center'},
                        ...
                        {name:'card_type_name',index:'card_type_name',width:450,align:'center',formatter : function(value, options, rData){  
