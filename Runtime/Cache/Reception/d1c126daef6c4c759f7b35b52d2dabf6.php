...
<div class="main-container" id="main-container">
  ...
  <div class="main-container-inner">
	...
	<div class="form-group">
			...
			<input class="date_ymd" type="text" id="time" name="time"/>
		</div>
                    ...
                    查询
 					...
 					<div class="tabbable">
                        <ul class="nav nav-tabs" id="myTab">
                          <?php if(is_array($classes)): $k = 0; $__LIST__ = $classes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$class): $mod = ($k % 2 );++$k;?><li  >
                                <a data-toggle="tab" href="#c<?php echo ($key); ?>"> <i class="green icon-shopping-cart bigger-110"></i>
                               <?php echo ($key); ?>
                                </a>
                            </li ><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
						...
						<?php if(is_array($classes)): $i = 0; $__LIST__ = $classes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$class): $mod = ($i % 2 );++$i;?><div id="c<?php echo ($key); ?>" class="tab-pane in ">
										...
										<ul class="list-unstyled">
							  		 		...
							  		 		<?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$c): $mod = ($i % 2 );++$i;?><tr> 
			 													...
			 													<td> <a href="<?php echo U('Reception/Appoint/appointlist/id/'.$c['id']);?>"   >查看预约情况</a></td>
