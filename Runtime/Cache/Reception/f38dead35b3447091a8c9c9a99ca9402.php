  ...
  <div class="main-container-inner">
    ...
    <div class="row"> 
        <div class="col-xs-12" id="fcontainer">
            ...
            <form class="form-inline" role="form" action="<?php echo U('Reception/Consume/query');?>" method="post" id="query_check_consume_form" style="margin-bottom:10px">
...
<div class="form-group">
                    ...
                    <select name="status" id="status"  class="form-control" oper="eq">
                        <option value="1">进馆</option>
                         <option value="0">出馆</option>
                    </select>
                   </div>
              <!--   <div class="form-group">
