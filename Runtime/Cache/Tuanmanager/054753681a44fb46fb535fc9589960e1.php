...
<div class="main-container" id="main-container">
  ...
  <div class="main-container-inner">
	...
	<div class="row">
		<div class="col-xs-12">
			<form   enctype="multipart/form-data" class="form-horizontal" role="form" id="addPtClassPublicForm" <?php if(empty($class)): ?>action="<?php echo U('Tuanmanager/Tclass/add');?>" <?php else: ?> action="<?php echo U('Tuanmanager/Tclass/edit');?>"<?php endif; ?>method="post">
			<input type="hidden" name="id" value="<?php echo ($class["id"]); ?>">
				...
				<label class="col-sm-1 control-label no-padding-right" for="pt_id">选择老师:</label>
					<div class="col-sm-3">  
						 <select name="pt_id" id="pt_id" class="form-control col-xs-10 col-sm-">
				          <?php if(is_array($pt)): $i = 0; $__LIST__ = $pt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$teacher): $mod = ($i % 2 );++$i;?><option value="<?php echo ($teacher["id"]); ?>"   <?php if($class['pt_id'] == $teacher['id']): ?>selected="selected"<?php endif; ?>><?php echo ($teacher["name_cn"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				        </select> 
					</div>

					<label class="col-sm-1 control-label no-padding-right" for="name">课程名称:</label>
					<div class="col-sm-3">
						<input type="text" id="name"  class="form-control col-xs-10 col-sm-5" name="name" value="<?php echo ($class["name"]); ?>"/>
					</div>　
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="name_en"  class="form-control col-xs-10 col-sm-5" name="name_en" value="<?php echo ($class["name_en"]); ?>"/>
					</div>
					<label class="col-sm-1 control-label no-padding-right" for="time">课时长(分钟):</label>
					<div class="col-sm-3">
						<input type="text" id="time"  class="form-control col-xs-10 col-sm-5" name="time" value="<?php echo ($class["time"]); ?>"/>
					</div>
				</div>
				<div class="form-group">
					...
					<select name="lang" id="lang" class="form-control col-xs-10 col-sm-3" >
						<option value="zh-chs"   <?php if($class['lang'] == 'zh-chs'): ?>selected="selected"<?php endif; ?>>中文</option>
						<option value="en-us"   <?php if($class['lang'] == 'en-us'): ?>selected="selected"<?php endif; ?> >英文</option>
							<option value="bili"   <?php if($class['lang'] == 'bili'): ?>selected="selected"<?php endif; ?> >双语</option>
					</select>
					...
					<div class="col-sm-3">
						...
						<option value="1"  <?php if($class['level'] == 1): ?>selected="selected"<?php endif; ?>>一级</option>
						<option value="2"  <?php if($class['level'] == 2): ?>selected="selected"<?php endif; ?>>二级</option>
						<option value="3"  <?php if($class['level'] == 3): ?>selected="selected"<?php endif; ?>>三级</option>
						<option value="4"  <?php if($class['level'] == 4): ?>selected="selected"<?php endif; ?>>四级</option>
						<option value="5"  <?php if($class['level'] == 5): ?>selected="selected"<?php endif; ?>>五级</option>
					</select>
					</div> 
				</div> 
				...
				<div class="form-group">
					...
					<div class="col-sm-3"> 
						<div class="profile-picture">
                        	...
                        	<img src="/Public/uploads/ptclass/<?php echo ($class["image"]); ?>?<?php echo ($class["update_time"]); ?>" alt="" onerror="this.src='/Public/images/class_default.jpg'" style="width:100px;height:100px" onclick="change_avatar(this)">
                        	</a>
                        </div> 
...
<script> 
	...
	ue.ready(function(){
		ue.setContent('<?php echo ($class["desc"]); ?>');
	})
