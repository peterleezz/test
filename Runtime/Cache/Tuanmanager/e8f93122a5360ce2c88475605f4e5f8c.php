  ...
  <div class="main-container-inner">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" id="editRoomForm"  action="<?php echo U('Tuanmanager/Room/edit');?>" method="post">
				<input type="hidden" id="id" value="<?php echo ($room["id"]); ?>">
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="name">名称:</label>
					<div class="col-sm-9">
						<input type="text" id="name"  class="col-xs-10 col-sm-5" name="name" value="<?php echo ($room["name"]); ?>"/>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						<?php if(empty($room)): ?><button class="btn btn-info" type="button"  onclick="editroom()">
...
<!-- inline scripts related to this page -->
    ...
    var extension ='<?php echo ($room["extension"]); ?>';
