...
<div class="main-container" id="main-container">
  ...
  <div class="row">
    <div class="col-xs-12" id="fcontainer">
      ...
      <form class="form-inline" role="form" action="<?php echo U('Cashier/Ptcontract/query');?>" method="post" id="cashier_ptcontract_form" style="margin-bottom:10px">
    ...
    $("#menu_39").addClass("active");
            ...
            var pager_selector = "#cashier_ptcontract_pager";                 
                jQuery(grid_selector).jqGrid({
                    url:"<?php echo U('Cashier/Ptcontract/query');?>",                 
                    datatype: "json",
                    height: "100%",    
