    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel-body">
                ...
                <div class="form-group col-xs-4">合同编号:<?php echo ($bill["serial_number"]); ?></div>
                ...
                <div class="form-group col-xs-4">
                 ...
                 <div class="form-group col-xs-4">
                    合同类型:
                    <?php switch($bill["type"]): case "0": ?>新增合同<?php break;?>
                        <?php case "3": ?>转让合同<?php break;?>
                        <?php case "4": ?>续费合同<?php break;?>
                        <?php case "5": ?>升级合同<?php break;?>
                        <?php default: ?>
                        买卡当天开卡<?php endswitch;?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal ajaxForm" id="validation-form" method="post" action="<?php echo U('Cashier/Contract/doPay');?>">
