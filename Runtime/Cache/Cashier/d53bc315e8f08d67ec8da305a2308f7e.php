    ...
    <div class="col-xs-12" id="fcontainer">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form id="pt_form_query" action="<?php echo U('Cashier/Pt/queryMember');?>">
              ...
              <div class="col-xs-12 col-sm-9">
                <div class="clearfix">
                  <select name="pt_id" id="pt_id" class="col-xs-12 col-sm-6">
                    ...
                    <?php if(is_array($pts)): $i = 0; $__LIST__ = $pts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pt): $mod = ($i % 2 );++$i;?><option value="<?php echo ($pt["id"]); ?>"><?php echo ($pt["name_cn"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                  </select>
...
var classesarr = eval("(" + '<?php echo ($classesarr); ?>' + ")");
