  ...
  <div class="main-container-inner">
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal ajaxForm" id="validation-form" method="post" action="<?php echo U('Cashier/Contract/doContinue');?>">
                    ...
                    <div class="col-xs-12 col-sm-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <input type="text" class="col-xs-12 col-sm-6" name="start_time" id="start_time"  value="<?php echo ($contract["end_time"]); ?>"></div>
                        ...
                        <div class="form-group red">
                                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="extra" >续会费:</label>

                                <div class="col-xs-12 col-sm-9">
                                    <input type="text" class=" col-xs-12 col-sm-6 red"  id="extra" readonly = "readonly" value="￥<?php echo ($extra); ?>（需单独付费）"></div>
            ...
            $("#card_type_id").change(function(){
                ...
                for(var i=0;i<saletypes.length;i++)
                {
                    if(saletypes[i].id==card_type_id)
                    {
                        ...
                        str = current_contract.end_time.replace(/-/g,"/");                        
                        ...
                        // year += Math.floor(month/12);
                        // month=month%12;  
                        // $("#end_time").val(year+"-"+padLeft(month,2)+"-"+day);
                        $("#should_pay").val(parseInt(saletypes[i].price));
