                             ...
                             <div class="col-sm-4">
                                ...
                                <div class="col-sm-8">
                                 <select name="mc_id" id="mc_id" class=" form-control"> 
                                        <?php if(is_array($mcs)): $i = 0; $__LIST__ = $mcs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mc): $mod = ($i % 2 );++$i;?><option value="<?php echo ($mc["id"]); ?>"    <?php if(0 != $member['mc_id']): if($mc['id'] == $member['mc_id']): ?>selected="selected"<?php endif; ?>  <?php else: ?>  <?php if($mc['id'] == $uid): ?>selected="selected"<?php endif; endif; ?>   ><?php echo ($mc["name_cn"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select> 
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4" >
                                ...
                                <div class="col-sm-8">
                                    <select name="near_club" id="near_club" class=" form-control">
                                        <?php if(is_array($clubs)): $i = 0; $__LIST__ = $clubs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$club): $mod = ($i % 2 );++$i;?><option value="<?php echo ($club["id"]); ?>"  <?php if(0 != $member['near_club']): if($club['id'] == $member['near_club']): ?>selected="selected"<?php endif; ?>    <?php else: ?>   <?php if($club['id'] == $club_id): ?>selected="selected"<?php endif; endif; ?>     ><?php echo ($club["club_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
