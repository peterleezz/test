...
<div class="main-container" id="main-container">
  ...
  <div class="main-container-inner">
    ...
    <div class="row">
        <div class="col-xs-12">
            <form class="form-inline" role="form" action="<?php echo U('Mc/Manage/getMembers');?>" method="post" id="mc_query_stmember" >
                    ...
                    <div class="input-group-btn">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="javascript:void(0)" onclick="$('#action').text('未接通电话');$('.detail_query').addClass('hide');st_query(11)">未接通电话</a>
                            </li>
        ...
        <div class="col-xs-12 detail_query hide"  >
            <form class="form-inline" role="form" action="<?php echo U('Mc/Manage/getMembers');?>" method="post" id="mc_query_member" >
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal ajaxForm" role="form" id="followupform" action="<?php echo U('Mc/Manage/addfollowup');?>">
