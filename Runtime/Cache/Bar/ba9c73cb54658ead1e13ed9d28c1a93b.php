...
<div class="main-container" id="main-container">
  ...
  <div class="row">
    ...
    <form class="form-inline " role="form" action="<?php echo U('Bar/Goods/salelist');?>" method="post" id="query_salelist_form" style="margin-bottom:10px">
    ...
    $("#menu_47").addClass("active");
            ...
            var pager_selector = "#sale_list_pager";                 
                jQuery(grid_selector).jqGrid({
                    url:"<?php echo U('Bar/Goods/salelist');?>",                 
                    datatype: "json",
                    height: "100%",    
