	...
	<div class="row" >
		<div class="col-xs-12"  style="margin:0px;padding:0">
			...
			<div class="table-responsive">
				<table id="clubs_table" class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
					...
					<tbody>
						<?php if(is_array($clubs)): $i = 0; $__LIST__ = $clubs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$club): $mod = ($i % 2 );++$i;?><tr>

								<td>
									<a href="<?php echo U('Brand/Shop/clubinfo?id='.$club['id']);?>"><?php echo ($club["club_name"]); ?></a>
								</td>
								...
								<td><?php echo ($club["create_time"]); ?></td>
								<td>
									<div class="action-buttons">
											
										<a class="green" href="<?php echo U('Brand/Shop/showEdit?id='.$club['id']);?>">
											<i class="icon-pencil bigger-130"></i>
										</a>
<!-- 
										<a class="red" href="javascript:void(0)" onclick="delClub(<?php echo ($club["id"]); ?>,this)">
