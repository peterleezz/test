				...
				<div class="form-group peaktime">
					...
					<div class="col-sm-6" >
						 ...
						 <div  class="col-sm-2">
							 ...
							 <?php $__FOR_START_2013582583__=0;$__FOR_END_2013582583__=24;for($i=$__FOR_START_2013582583__;$i < $__FOR_END_2013582583__;$i+=1){ ?><option value='<?php echo str_pad($i,2,"0",STR_PAD_LEFT).":00";?>'> <?php echo str_pad($i,2,"0",STR_PAD_LEFT);?>:00</option> 
						...
						<div  class="col-sm-2">
							 ...
							 <?php $__FOR_START_72941973__=0;$__FOR_END_72941973__=24;for($i=$__FOR_START_72941973__;$i < $__FOR_END_72941973__;$i+=1){ ?><option value='<?php echo str_pad($i,2,"0",STR_PAD_LEFT).":00";?>'> <?php echo str_pad($i,2,"0",STR_PAD_LEFT);?>:00</option> 
								<option value='<?php echo str_pad($i,2,"0",STR_PAD_LEFT).":30";?>'> <?php echo str_pad($i,2,"0",STR_PAD_LEFT);?>:30</option><?php } ?> 
						 </select>
						 </div>
						 <div  class="col-sm-4">
