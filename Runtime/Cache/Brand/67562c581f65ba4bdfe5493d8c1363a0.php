  ...
  <div class="main-container-inner">
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" id="addClubForm" <?php if(empty($club)): ?>action="<?php echo U('Brand/Shop/add');?>" <?php else: ?> action="<?php echo U('Brand/Shop/edit');?>"<?php endif; ?>method="post">
			<input type="hidden" name="id" value="<?php echo ($club["id"]); ?>">
			<input type="hidden" name="lat" id="lat" value="<?php echo ($club["lat"]); ?>">
			<input type="hidden" name="lon" id="lon" value="<?php echo ($club["lon"]); ?>">
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="club_name">会所名称:</label>
					<div class="col-sm-9">
						<input type="text" id="club_name"  class="col-xs-10 col-sm-5" name="club_name" value="<?php echo ($club["club_name"]); ?>"/>
					</div>
				</div>
				<!-- <div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-2">会所代码:</label>
					<div class="col-sm-9">
						<input type="text" id="form-field-2"  class="col-xs-10 col-sm-5" name="code" value="<?php echo ($club["code"]); ?>"/>
					</div>
				</div> -->
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" id="form-field-4"  class="col-xs-10 col-sm-5" name="phone" value="<?php echo ($club["phone"]); ?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-5">传真:</label>
					<div class="col-sm-9">
						<input type="text" id="form-field-5"  class="col-xs-10 col-sm-5" name="fax" value="<?php echo ($club["fax"]); ?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-6">电子邮件:</label>
					<div class="col-sm-9">
						<input type="email" id="form-field-6"  class="col-xs-10 col-sm-5" name="email" value="<?php echo ($club["email"]); ?>"/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-7">备注:</label>
					<div class="col-sm-4">
						<textarea id="form-field-7" rows="5" class="form-control" name="desc" ><?php echo ($club["desc"]); ?></textarea>
					</div>
				</div>
				...
				<div class="clearfix form-actions">
					<div class="col-md-offset-3 col-md-9">
						<?php if(empty($club)): ?><button class="btn btn-info" type="submit"> <i class="icon-ok bigger-110"></i>
								提交
							</button>
							<?php else: ?>
...
<!-- inline scripts related to this page -->
	...
	function loadScript() {  
	  ...
	  script.src = "http://api.map.baidu.com/api?v=2.0&ak=<?php echo ($baidu_key); ?>&callback=initialize";//此为v1.5版本的引用方式   
    ...
    $("#menu_19").addClass("active");
		...
		var loc = "<?php echo ($club["location"]); ?>";
		var s4value=null;
		function promptinfo()
		{
