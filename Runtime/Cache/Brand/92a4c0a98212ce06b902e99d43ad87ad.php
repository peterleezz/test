  ...
  <div class="main-container-inner">
	...
	<div class="row">
		<div class="col-xs-12" id="fcontainer">
			...
			<form class="form-inline" role="form" action="<?php echo U('Brand/Mcontract/query');?>" method="post" id="query_contract_form" style="margin-bottom:10px">
    ...
    $("#menu_16").addClass("active");
            ...
            var pager_selector = "#contract_pager";                 
                jQuery(grid_selector).jqGrid({
                    url:"<?php echo U('Brand/Mcontract/query');?>",                 
                    datatype: "json",
                    height: "100%",    
