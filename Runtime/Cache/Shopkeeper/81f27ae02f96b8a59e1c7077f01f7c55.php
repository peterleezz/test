...
<div class="main-container" id="main-container">
  ...
  <div class="main-container-inner">
    ...
    -->
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-inline" role="form" action="<?php echo U('Shopkeeper/Employee/query');?>" method="post" id="query_employee">
     ...
     <div class="form-group">
                      ...
                      <select name="role" id="role"  oper="eq">
                            ...
                            <?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><option value="<?php echo ($role["id"]); ?>"><?php echo ($role["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
    ...
    var pager_selector = "#employee_grid-pager";
                ...
                jQuery(grid_selector).jqGrid({
                    ...
                    colModel:[
                        ...
                        {name:'id',index:'id',sortable:true,editable: false ,width:150,align:'center',formatter : function(value, options, rData){
                            return value;
                        ...
                        {name:'sex',index:'sex', width:80,editoptions:{size:"20",maxlength:"30"},align:'center',edittype:"select",editoptions:{value:"male:男;female:女"},formatter : function(value, options, rData){
                           return value=='male'|| value=='男'?"男":"女";
            },},
                        {name:'phone',index:'phone', width:130,editoptions:{size:"20",maxlength:"30"},align:'center'},
                        {name:'work_status',index:'work_status', width:200,align:'center',search:true,edittype:"select",editoptions:{value:"0:在职;1:离职;2:实习;3:兼职"},formatter : function(value, options, rData){
            ...
            {name:'role',index:'role', width:130,editoptions:{size:"20",maxlength:"30"},align:'center',formatter : function(value, options, rData){
                        ...
                        {name:'create_time',index:'create_time',editable: false , width:200,align:'center',editable: true,sorttype:'date', editrules:{date:true},formatter:'date', datefmt:'Y-m-d',},    
                    ...
                    editurl: "/Shopkeeper/Employee/set",   
...
jQuery(grid_selector).jqGrid('navButtonAdd',pager_selector,{position: "first",buttonicon : 'icon-pencil blue',caption:"",title:"修改",
    ...
    if (id) {
        ...
        window.location.href = "/Shopkeeper/Employee/showEdit/id/"+ret.id;
...
jQuery(grid_selector).jqGrid('navButtonAdd',pager_selector,{position: "first",buttonicon : 'icon-plus-sign purple',caption:"",title:"新增",
    onClickButton:function(){ 
         window.location.href = "/Shopkeeper/Employee/showAdd";
    } 
});
