        ...
        <div class="col-xs-12" id="ptclass">
           <form class="form-inline" role="form" action="<?php echo U('Pt/Class/query');?>" method="post" id="pt_class_public" style="margin-bottom:10px"> 
                                    ...
                                    <div class="form-group">
                                        <label  for="teacher_name">选择老师:</label>
                                           <select name="pt_id" id="pt_id" class="form-control" oper="cn">
                                            <option value="0">所有老师</option>
                                          <?php if(is_array($pt)): $i = 0; $__LIST__ = $pt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$teacher): $mod = ($i % 2 );++$i;?><option value="<?php echo ($teacher["id"]); ?>"><?php echo ($teacher["name_cn"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select> 
                                       </div> 
