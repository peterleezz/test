...
<div class="main-container" id="main-container">
  ...
  <div class="main-container-inner">
	...
	<div class="row">
		<div class="col-xs-12">
			<form   enctype="multipart/form-data" class="form-horizontal" role="form" id="addPtClassPublicForm" <?php if(empty($class)): ?>action="<?php echo U('Shopkeeper/Tclass/add');?>" <?php else: ?> action="<?php echo U('Shopkeeper/Tclass/edit');?>"<?php endif; ?>method="post">
