	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="form-group">
					...
					<?php $__FOR_START_528525910__=1;$__FOR_END_528525910__=10;for($i=$__FOR_START_528525910__;$i < $__FOR_END_528525910__;$i+=1){ ?><option value="<?php echo ($i); ?>"  <?php if($i == $employee['level']): ?>selected="selected"<?php endif; ?> ><?php echo ($i); ?>级</option><?php } ?>
