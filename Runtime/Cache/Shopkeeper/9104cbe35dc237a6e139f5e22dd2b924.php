...
<div class="main-container" id="main-container">
  ...
  <div class="main-container-inner">
	...
	<ul class="breadcrumb">
		...
		<li class="active"><a href="<?php echo U('Shopkeeper/Employee/index');?>">员工管理</a></li>
	...
	<div class="row">
		<div class="col-xs-12">
			<form  enctype="multipart/form-data"  class="form-horizontal" role="form" id="addEmployeeForm" <?php if(empty($employee)): ?>action="<?php echo U('Shopkeeper/Employee/add');?>" <?php else: ?> action="<?php echo U('Shopkeeper/Employee/edit');?>"<?php endif; ?>method="post">
			...
			<div class="form-group">
					...
					<?php $__FOR_START_1806120223__=1;$__FOR_END_1806120223__=10;for($i=$__FOR_START_1806120223__;$i < $__FOR_END_1806120223__;$i+=1){ ?><option value="<?php echo ($i); ?>"  <?php if($i == $employee['level']): ?>selected="selected"<?php endif; ?> ><?php echo ($i); ?>级</option><?php } ?>
			...
			<!-- 	<div class="form-group">
					...
					<div class="col-sm-7"> 
							<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="/cankao/ace/assets/avatars/profile-pic.jpg" />
							 </span>
					</div>
				</div>
				  -->
