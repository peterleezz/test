	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="form-group">
					...
					<?php $__FOR_START_83053265__=1;$__FOR_END_83053265__=10;for($i=$__FOR_START_83053265__;$i < $__FOR_END_83053265__;$i+=1){ ?><option value="<?php echo ($i); ?>"  <?php if($i == $employee['level']): ?>selected="selected"<?php endif; ?> ><?php echo ($i); ?>级</option><?php } ?>
