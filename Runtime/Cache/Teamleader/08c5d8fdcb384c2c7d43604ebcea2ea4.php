  ...
  <div class="main-container-inner">
    ...
    <ul class="breadcrumb">
        <li> <i class="icon-home home-icon"></i>
            <a href="<?php echo U('Home/Main/main');?>">组长</a>
        </li>
    ...
    <div class="row">
        <div class="col-xs-12">
            <form class="form-inline" role="form" action="<?php echo U('Teamleader/Member/getMembers');?>" method="post" id="mcmanager_query_member" > 
    ...
    function point()
{
    ...
    if (id) {
        ...
        $.post("/Teamleader/Member/assign", {members:selectedIds,mc_id:mcid}, function(data,textStatus){
...
function showdetail(id)
{
 if(lasdetailtid==id && $("#show_detail").text()!='')return; lasdetailtid=id;
     $.post("/Teamleader/Member/show", {id:id}, function(data,textStatus){
                              $("#show_detail").text("");
    ...
    else
    {
        ...
        $(".define :input").val("");
                ...
                jQuery(grid_selector).jqGrid({
                    url:"/Teamleader/Member/getMembers",                 
                    datatype: "json",
                    height: "100%",  
                    width:"100%",          
                    mtype:"POST",
