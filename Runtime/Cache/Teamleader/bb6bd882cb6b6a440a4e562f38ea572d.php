...
<div class="main-container" id="main-container">
  ...
  <div class="main-container-inner">
    ...
    <div class="row">
        <div class="col-xs-12">
            <form class="form-inline" role="form" action="<?php echo U('Mcmanager/Mcsale/queryservicelist');?>" method="post" id="mcmanager_query_servicelist" > 
...
$("#menu_1057").addClass("active open");
